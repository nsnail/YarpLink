using Prometheus;
using YarpLink.BizServer.Host.Extensions;
using YarpLink.Host.Extensions;
using YarpLink.Host.Middlewares;

namespace YarpLink.BizServer.Host;

/// <summary>
///     启动类
/// </summary>
public sealed class Startup : YarpLink.Host.Startup
{
    /// <summary>
    ///     程序入口
    /// </summary>
